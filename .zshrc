...
# Add wisely, as too many plugins slow down shel˝l startup.
plugins=(
    git
    docker
)
...
__conda_setup="$('/Users/aast/opt/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/aast/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/aast/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/aast/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
